...
public class C02DortIslemMethodlu {
   ...
   dort islemden biri ile isleme koyup sonucunu yazdiriniz
    ...
    public static double calculator(char islemSec, double num1, double num2) {
        double sonuc = 0;
        switch (islemSec) {
            case '+':
                sonuc = num1 + num2;
    ...
    public static double bolme(double bolunen,double bolen) {
        ...
        if (bolen==0 && !(bolunen==0)) return Double.POSITIVE_INFINITY;
        else if (bolen == 0 && bolunen==0) return Double.NaN;
